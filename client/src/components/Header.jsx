...
const Header = () => {
  ...
  return (
    ...
    ' initial={{ opacity: 0.2, y: 100 }}
      ...
      <motion.h1 className='text-5xl max-w-[300px] sm:7xl sm:max-w-[590px]
      ...
      >Unleash your creativity with AI.Turn your imagination into visual art in seconds - just type,and whatch the magic happen.</motion.p>
      ...
      <motion.div className='flex flex-wrap justify-center mt-16 gap-3'
        ...
        {Array(6).fill(' ').map((item, index) => (
          <motion.img
          key={index} // ✅ correct spelling
          whileHover={{scale:1.05,duration:0.1}} className='rounded hover:scale-105 transition-all duration-300 cursor-pointer max-sm:w-10 ' src={index % 2 == 0 ? assets.sample_img_1 : assets.sample_img_2} alt=""  width={70} />
        ))}
      </motion.div>
      <motion.p 
             initial={{ opacity: 0 }}
