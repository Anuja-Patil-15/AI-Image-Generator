 ...
 const onSubmitHandler = async (e) =>{
  ...
  return (
    ...
    initial={{opacity:0.2 ,y:100}}
        ...
        viewport={{once:true}}
    onSubmit={onSubmitHandler} className='flex flex-col mmin-h-[90vh] justify-center items-center'>
    <div >
...
{!isImageLoaded &&
 <div className='flex w-full max-w-xl bg-neutral-500 text-white text-sm p-0.5 mt-10 rounded-full'>
    ...
    type="text" placeholder='Describe what you want to generate ' className='flex-1 bg-transparent outline-none ml-8 max-sm:w-20 placeholder-color' name="" id="" />
